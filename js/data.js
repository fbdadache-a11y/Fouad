const DATA = {
  ...
  en: {
    ...
    projects: {
      ...
      items: [
        {
          name:    "ECONOVO",
          tag:     "Student Club Website",
          desc:    "The official website of ECONOVO, the student club I co-founded — designed and built solo to showcase the club's mission, activities, and events to the university community.",
          url:     "https://econovo.is-cool.dev",
          urlLabel: "econovo.is-cool.dev",
          cta:     "Visit website",
        },
        {
          name:    "MARVINE",
          tag:     "Brand Identity — Concept Project",
          desc:    "A self-directed brand identity system for a fictional infrastructure company — logomark, color and type rationale, and stationery mockups, designed to practice systematic visual identity work end to end.",
          image:   "assets/marvine-brand-1.jpg",
          url:     "assets/marvine-brand-concept.pdf",
          urlLabel: "View the full brand deck (PDF)",
          cta:     "View deck",
        },
      ],
    },
    ...
    contact: {
      ...
      cvLbl:    "Download CV",
      cvValue:  "PDF — English",
      cvFile:   "assets/Fouad_Dadache_CV_EN.pdf",
    },
    footer: {
  ...
  fr: {
    ...
    projects: {
      label: "Projets",
      title: "Ce que j'ai lancé.",
      items: [
        {
          name:    "ECONOVO",
          tag:     "Site du Club Étudiant",
          desc:    "Le site officiel d'ECONOVO, le club étudiant que j'ai cofondé — conçu et développé seul pour présenter la mission, les activités et les événements du club à la communauté universitaire.",
          url:     "https://econovo.is-cool.dev",
          urlLabel: "econovo.is-cool.dev",
          cta:     "Visiter le site",
        },
        {
          name:    "MARVINE",
          tag:     "Identité de marque — Projet conceptuel",
          desc:    "Un système d'identité de marque autodirigé pour une entreprise d'infrastructure fictive — logo, logique de palette et de typographie, et mockups de papeterie, conçu pour pratiquer un travail d'identité visuelle complet et méthodique.",
          image:   "assets/marvine-brand-1.jpg",
          url:     "assets/marvine-brand-concept.pdf",
          urlLabel: "Voir le dossier de marque complet (PDF)",
          cta:     "Voir le dossier",
        },
      ],
    },
    ...
    contact: {
      ...
      cvLbl:    "Télécharger le CV",
      cvValue:  "PDF — Français",
      cvFile:   "assets/Fouad_Dadache_CV_FR.pdf",
    },
    footer: {
  ...
  ar: {
    ...
    nav: { about: "نبذة", experience: "الخبرة", projects: "المشاريع", skills: "المهارات", contact: "تواصل" },
    hero: {
    ...
    projects: {
      ...
      items: [
        {
          name:    "ECONOVO",
          tag:     "موقع النادي الطلابي",
          desc:    "الموقع الرسمي لنادي ECONOVO الذي شاركت في تأسيسه — صممته وبنيته بمفردي لعرض رسالة النادي وأنشطته وفعالياته على المجتمع الجامعي.",
          url:     "https://econovo.is-cool.dev",
          urlLabel: "econovo.is-cool.dev",
          cta:     "زيارة الموقع",
        },
        {
          name:    "MARVINE",
          tag:     "هوية بصرية — مشروع شخصي تجريبي",
          desc:    "نظام هوية بصرية بمبادرة شخصية لشركة بنية تحتية افتراضية — شعار، ومنطق اختيار الألوان والخطوط، ونماذج تطبيقية للقرطاسية، صممته لأتمرن على العمل المنهجي الكامل في بناء هوية بصرية.",
          image:   "assets/marvine-brand-1.jpg",
          url:     "assets/marvine-brand-concept.pdf",
          urlLabel: "عرض ملف الهوية الكامل (PDF)",
          cta:     "عرض الملف",
        },
      ],
    },
    ...
    contact: {
      ...
      cvLbl:    "تحميل السيرة الذاتية",
      cvValue:  "PDF — إنجليزي",
      cvFile:   "assets/Fouad_Dadache_CV_EN.pdf",
    },
    footer: {
      built:  "صُمم وبُني بواسطة فؤاد دداش",
