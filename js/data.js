const DATA = {
  ...
  ar: {
    ...
    hero: {
      ...
      headline: ["طالب إدارة أعمال،", "وباني مجتمع", "وصانع محتوى رقمي."],
      sub:      "شريك مؤسس في نادي ECONOVO، وطالب سنة أولى إدارة أعمال بجامعة محمد البشير الإبراهيمي. أجمع بين الجدّية الأكاديمية والقيادة الميدانية للمجتمعات وسرد القصص عبر المحتوى الرقمي.",
      scroll:   "مرّر للأسفل لاستكشاف المزيد",
    },
    about: {
      label: "نبذة عني",
      title: "طالب يبني وهو يتعلّم.",
      bio1:  "أنا فؤاد، طالب سنة أولى إدارة أعمال بجامعة محمد البشير الإبراهيمي في برج بوعريريج، الجزائر. في ديسمبر 2025، شاركت في تأسيس ECONOVO — نادٍ طلابي حقّق 4500 مشاهدة عضوية خلال يوم واحد، وجمع 39 مشاركًا في فعاليته الافتتاحية.",
      bio2:  "يقع عملي عند تقاطع التنسيق الإداري والتواصل الرقمي وأدوات الذكاء الاصطناعي. أنا متاح لفرص عمل عن بُعد أو حضورية أستطيع من خلالها توظيف مهاراتي في صناعة المحتوى وإدارة المجتمعات والدعم التنظيمي.",
      stats: [
        { value: "+4,500", label: "مشاهدة عضوية خلال 24 ساعة", icon: "trending-up" },
        { value: "39",     label: "مشارك في الفعالية",          icon: "users" },
        { value: "3",      label: "لغات يتحدث بها",             icon: "globe" },
      ],
      eduLabel: "المسار الدراسي",
      edu: [
        {
          degree:  "ليسانس في إدارة الأعمال (السنة الأولى، جذع مشترك)",
      ...
      items: [
        {
          ...
          bullets: [
            "خطّطت ونسّقت فعالية إطلاق النادي (ديسمبر 2025) بحضور 39 مشاركًا، مع إدارة كاملة للّوجستيات والتواصل واستقبال الحضور.",
            ...
            "نسّقت مع إدارة الجامعة لاعتماد أنشطة النادي ومتابعتها بانتظام.",
          ],
        },
      ],
    },
    skills: {
      ...
      cats: [
        ...
        { name: "الذكاء الاصطناعي",       icon: "cpu",       items: ["ChatGPT", "Claude AI", "البحث بمساعدة الذكاء الاصطناعي"] },
    ...
    contact: {
      ...
      sub:      "متاح لفرص عمل عن بُعد أو حضورية.",
